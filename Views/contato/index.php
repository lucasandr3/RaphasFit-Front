          ...
          <div class="offcanvas offcanvas-collapse order-lg-2" id="primaryMenu">
            ...
            <div class="offcanvas-body">
              ...
              <li class="nav-item dropdown dropdown-mega <?=($viewData['menu'] == 'home') ? 'active':''?>">
                  <a class="nav-link" href="https://descomplicazap.com/doceria-loh-macedo" target="_blank">Loja Modelo</a>
                </li>
      ...
      <section class="jarallax bg-gradient pt-5 pb-7 pt-md-7" data-jarallax data-speed="0.25"><span class="position-absolute top-0 start-0 w-100 h-100 bg-gradient opacity-80"></span>
        ...
        <div class="container position-relative zindex-5 pt-3 pb-7 pt-md-0">
          <div class="row justify-content-center pb-7">
            <div class="col-lg-10">
              <h1 class="text-light">Fale com a Gente</h1>
              <p class="text-light">Entre em contato preenchendo o formulário abaixo ou ligue para nós agora</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="col-lg-6 col-md-7 offset-lg-1 pb-2 mb-5" style="margin-top: -260px;">
            <div class="card border-0 shadow-lg">
              <form class="card-body needs-validation p-5" novalidate>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-fn">Nome Completo<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" type="text" id="cont-fn" placeholder="Digite aqui..." required>
                  <div class="invalid-feedback">Por favor digite seu nome completo!</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-email">E-mail<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" type="email" id="cont-email" placeholder="Digite aqui..." required>
                  <div class="invalid-feedback">Digite um e-mail!</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-phone">Telefone</label>
                  <input class="form-control bg-image-0" type="text" id="cont-phone" data-format="custom" data-delimiter="-" data-blocks="2 4 2 2" placeholder="00-000000000">
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-company">Nome do Estabelecimento</label>
                  <input class="form-control bg-image-0" type="text" id="cont-company" placeholder="Digite aqui...">
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-subject">Assunto<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" type="text" id="cont-subject" placeholder="Digite aqui..." required>
                  <div class="invalid-feedback">Escreva o assunto!</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-message">Mensagem<sup class="text-danger ms-1">*</sup></label>
                  <textarea class="form-control" id="cont-message" rows="5" placeholder="Escreva aqui..." required></textarea>
