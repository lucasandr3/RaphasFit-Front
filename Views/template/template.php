  ...
  <body>
    ...
    <main class="page-wrapper">
      ...
      <section class="position-relative pt-7">
        <!-- Background-->
        <div class="position-absolute jarallax bg-gradient w-100" style="top: 0; left: 0; height: 667px;" data-jarallax data-speed="0.25"><span class="position-absolute top-0 start-0 w-100 h-100 bg-gradient" style="opacity: .85;"></span>
          <div class="jarallax-img" style="background-image: url(<?=url('assets/img/demo/mobile-app/contact.jpg')?>);"></div>
    ...
    <!-- Back to top button-->
    <!-- <a class="btn-scroll-top" href="#top" data-scroll data-fixed-element><span class="btn-scroll-top-tooltip text-muted fs-sm me-2"></span><i class="btn-scroll-top-icon ai-arrow-up">   </i></a> -->
...
<!-- Mirrored from around.createx.studio/demo-mobile-app.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Mar 2021 21:46:18 GMT -->
</html>