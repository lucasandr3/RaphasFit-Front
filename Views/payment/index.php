...
<head>
    <meta charset="utf-8">
    <title>Registro - DescomplicaZap</title>
    <!-- SEO Meta Tags-->
    <meta name="description" content="PedeZap - Cardápio Digital">
    <meta name="keywords" content="cardápio, digital, pedido, whatsapp">
    <!-- Viewport-->
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon and Touch Icons-->
    <link rel="apple-touch-icon" sizes="180x180" href="apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="http://localhost/zapdevelop/assets/giphy.gif">
    <link rel="icon" type="image/png" sizes="16x16" href="http://localhost/zapdevelop/assets/giphy.gif">
  ...
  scroll-behavior: smooth;
    ...
    <!-- Vendor Styles-->
    <link rel="stylesheet" media="screen" href="<?=url('assets/vendor/simplebar/dist/simplebar.min.css')?>"/>
    <link rel="stylesheet" media="screen" href="<?=url('assets/vendor/tiny-slider/dist/tiny-slider.css')?>"/>
  ...
  <body>
    ...
    <div class="page-loading active">
      <div class="page-loading-inner">
        ...
        <img src="http://localhost/zapdevelop/assets/site/assets/images/giphy.gif" style="width:100px;"/>
      </div>
    </div>
    <main class="page-wrapper">
      ...
      <!--              </label>-->
      <!--            </div>-->
      <!--            <button class="btn btn-primary d-block w-100" type="submit">Cadastre-se</button>-->
      <!--            <p class="fs-sm pt-3 mb-0">Already have an account? <a href='#' class='fw-medium' data-view='#modal-signin-view'>Área do Cliente</a></p>-->
      <!--          </form>-->
      <!--        </div>-->
      <!--      </div>-->
      ...
      <header class="header navbar navbar-expand-lg navbar-dark navbar-floating navbar-sticky" data-scroll-header data-fixed-element>
        <div class="container px-0 px-xl-3">
          <button class="navbar-toggler ms-n2 me-2" type="button" data-bs-toggle="offcanvas" data-bs-target="#primaryMenu"><span class="navbar-toggler-icon"></span></button><a class="navbar-brand flex-shrink-0 order-lg-1 mx-auto ms-lg-0 pe-lg-2 me-lg-4" href="http://localhost/zapdevelop/"><img class="navbar-floating-logo d-none d-lg-block" src="http://localhost/zapdevelop/assets/logonew.jpg" alt="Around" width="153"><img class="navbar-stuck-logo" src="http://localhost/zapdevelop/assets/logonew.jpg" alt="Around" width="153"><img class="d-lg-none" src="http://localhost/zapdevelop/assets/logonew.jpg" alt="Around" width="58"></a>
          <!--<div class="d-flex align-items-center order-lg-3 ms-lg-auto"><a style="display:flex;" class="nav-link-style fs-sm text-nowrap" href="#modal-signin" data-bs-toggle="modal" data-view="#modal-signin-view"><i class="ai-user fs-xl me-2 align-middle"></i>Área do Cliente</a><a class="btn btn-translucent-light ms-grid-gutter d-none d-lg-inline-block navbar-btn" href="#modal-signin" data-bs-toggle="modal" data-view="#modal-signup-view">Criar Conta</a><a class="btn btn-gradient ms-grid-gutter d-none d-lg-inline-block navbar-stuck-btn" href="#modal-signin" data-bs-toggle="modal" data-view="#modal-signup-view">Criar Conta</a></div>-->
          <div class="offcanvas offcanvas-collapse order-lg-2" id="primaryMenu">
            ...
            <div class="offcanvas-body">
              ...
              <li class="nav-item dropdown dropdown-mega ">
                  <a class="nav-link" href="http://localhost/zapdevelop/doceria-loh-macedo" target="_blank">Loja Modelo</a>
                </li>
                <li class="nav-item dropdown dropdown-mega ">
                  <a class="nav-link" href="http://localhost/zapdevelop/contato">Fale com a Gente</a>
                </li>
                <!-- <li class="nav-item dropdown dropdown-mega"><a class="nav-link" href="#">Ajuda</a></li> -->
                  </ul>
                </li>
              </ul>
            </div>
      ...
      <section class="jarallax bg-gradient pt-5 pb-7 pt-md-7" data-jarallax data-speed="0.25"><span class="position-absolute top-0 start-0 w-100 h-100 bg-gradient opacity-80"></span>
        <div class="jarallax-img" style="background-image: url(http://localhost/zapdevelop/assets/img/pages/contacts/con1.jpg);background-size: contain;"></div>
        ...
        <div class="container position-relative zindex-5 pt-3 pb-7 pt-md-0">
          <div class="row justify-content-center pb-7">
            <div class="col-lg-10">
              <h1 class="text-light">Conclua o Cadastro</h1>
              <p class="text-light">Preencha os dados de Pagamento</p>
            </div>
          </div>
        </div>
      </section>

        <section class="container position-relative zindex-5 pb-5" style="margin-top: -280px;margin-left: 155px;">
        <div class="row align-items-center">
          <div class="col-md-6 mb-5 mb-md-0">
            <div class="accordion" id="faq">
              <div class="accordion-item shadow">
                <h2 class="accordion-header" id="faq-heading-1">
                  <button class="accordion-button" style="background-color: #fff;border-bottom-left-radius: 15px;border-bottom-right-radius: 15px;" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1" aria-expanded="true" aria-controls="faq-content-1">Pagar com Cartão de Crédito</button>
                </h2>
                <div class="accordion-collapse collapse show" id="faq-content-1" aria-labelledby="faq-heading-1" data-bs-parent="#faq" style="margin-top: -12px;">
                  <div class="accordion-body" style="background-color: #fff;padding-top:15px;">
                    <div class="fs-sm">
                        <form action="<?=url('payment/pay_action')?>" method="post" id="paymentForm">
                  <h3 class="title">Dados Pessoais</h3>
                  <div class="row mb-3">
                    <div class="form-group col">
                      <label for="email" class="mb-2">E-mail</label>
                      <input id="email" name="email" type="text" class="form-control" placeholder="Digite o e-mail"></select>
                    </div>
                  </div>
                  <div class="row">
                    <div class="form-group col-sm-5">
                      <label for="docType" class="mb-2">Tipo de Documento</label>
                      <select id="docType" name="docType" data-checkout="docType" type="text" class="form-control"></select>
                    </div>
                    <div class="form-group col-sm-7">
                      <label for="docNumber" class="mb-2">Número</label>
                      <input id="docNumber" name="docNumber" data-checkout="docNumber" type="text" class="form-control" data-format="custom" placeholder="Digite sem espaços e caracteres"/>
                    </div>
                  </div>
                  <br>
                  ...
                  <div class="row mb-3">
                    <div class="form-group col-sm-8 mb-3">
                      <label for="cardholderName" class="mb-2">Titular do cartão</label>
                      <input id="cardholderName" data-checkout="cardholderName" type="text" class="form-control" placeholder="Digite o Nome do Titular">
                    </div>
                    <div class="form-group col-sm-4 mb-3">
                      <label for="" class="mb-2">Data de validade</label>
                      <div class="input-group expiration-date">
                        ...
                        <span class="date-separator" style="margin-top: 9px;margin-left:5px;margin-right: 5px;">/</span>
                        <input type="text" class="form-control" placeholder="AA" id="cardExpirationYear" data-checkout="cardExpirationYear"
                          onselectstart="return false" onpaste="return false" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off>
                      </div>
                    </div>
                    <div class="form-group col-sm-8 mb-3">
                      <label for="cardNumber" class="mb-2">Número do cartão</label>
                      <input type="text" class="form-control input-background" id="cardNumber" data-checkout="cardNumber"
                        onselectstart="return false" onpaste="return false" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off placeholder="Digite sem espaços e caracteres">
                    </div>
                    <div class="form-group col-sm-4 mb-3">
                      <label for="securityCode" class="mb-2">CVV</label>
                      <input id="securityCode" data-checkout="securityCode" type="text" class="form-control"
                        onselectstart="return false" onpaste="return false" onCopy="return false" onCut="return false" onDrag="return false" onDrop="return false" autocomplete=off placeholder="000">
                    </div>
                    <div id="issuerInput" class="form-group col-sm-12 hidden  mb-3">
                      <label for="issuer" class="mb-2">Issuer</label>
                      <select id="issuer" name="issuer" data-checkout="issuer" class="form-control"></select>
                    </div>
                    <div class="form-group col-sm-12">
                      <label for="installments" class="mb-2">Parcelas</label>
                      <select type="text" id="installments" name="installments" class="form-control"></select>
                    </div>
                    <div class="form-group col-sm-12">
                      <input type="hidden" name="transactionAmount" id="amount" value="49.90" />
                      <input type="hidden" name="paymentMethodId" id="paymentMethodId" />
                      <input type="hidden" name="description" id="description" />
                      <br>
                      <button type="submit" class="btn btn-primary btn-block checkout-btn" style="width: 100%;">Pagar</button>
                    </div>
                  </div>
              </form>
                    </div>
              ...
              <div class="accordion-item shadow">
                <h2 class="accordion-header" id="faq-heading-2">
                  <button class="accordion-button collapsed" style="background-color: #fff;border-radius: 14px;" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2" aria-expanded="false" aria-controls="faq-content-2">Pagar com Boleto</button>
                </h2>
                <div class="accordion-collapse collapse" id="faq-content-2" aria-labelledby="faq-heading-2" data-bs-parent="#faq" style="background:#fff;border-bottom-right-radius: 14px;border-bottom-left-radius: 14px;margin-top:-12px;">
                  <div class="accordion-body" style="padding-top: 15px;">
                    <div class="fs-sm">
                        <form action="<?=url('payment/pay_action')?>" method="post" id="paymentForm">
                  <p>Enviaremos o Boleto por e-mail ou whatsapp</p>
                  <div class="row mb-3">
                    <div class="form-group col">
                      <label for="email" class="mb-2">E-mail</label>
                      <input id="email" name="email" type="text" class="form-control" placeholder="Digite o e-mail"></select>
                  ...
                  <div class="row mb-3" style="text-align:center;">
                    <p style="margin:0;font-weight:bold;">OU Whatsapp</p>
                  </div>
                  <div class="row mb-3">
                    <div class="form-group col">
                      <label for="whats" class="mb-2">Whatsapp</label>
                      <input id="whats" name="email" type="text" class="form-control" placeholder="Digite o whatsapp"></select>
                    </div>
                  </div>
              ...
              <div class="accordion-item shadow">
                <h2 class="accordion-header" id="faq-heading-3">
                  <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-3" aria-expanded="false" aria-controls="faq-content-3" style="background:#fff;border-top-left-radius: 14px;border-top-right-radius: 14px;">Pagar com Pix</button>
                </h2>
                <div class="accordion-collapse collapse" id="faq-content-3" aria-labelledby="faq-heading-3" data-bs-parent="#faq" style="background: #fff;">
                  <div class="accordion-body">
                     <div class="fs-sm">
          
                          <div class="row mb-3">
                            <div class="form-group col">
                              <label for="whats" class="mb-2">Pague com o Pix</label>
                              <p>09861385681<p/>
                            </div>
                          </div>
                            
                            <input type="hidden" id="texto-pix" value="09861385681" />
                        
                          <div class="row mb-3">
                            <div class="form-group col-sm-12">
                              <button class="btn btn-primary btn-block checkout-btn" id="botao-pix" style="width: 100%;">Copiar</button>
                            </div>
                          </div>
            ...
            <div class="col-md-6">
              <!--<img class="d-block mx-auto" src="http://localhost/zapdevelop/assets/img/pages/contacts/questions.pn" alt="Illustration">-->
            </div>
        </div>
      </section>
      ...
      <!--      <div class="card border-0 shadow-lg" style="padding:20px;">-->
      <!--      <form action="<?=url('payment/pay_action')?>" method="post" id="paymentForm">-->
      <!--            <h3 class="title">Dados Pessoais</h3>-->
      <!--            <div class="row mb-3">-->
      <!--              <div class="form-group col">-->
      ...
      <!--          <img src="http://localhost/zapdevelop/assets/img/pages/contacts/man.png" style="transform: scaleX(-1);">-->
      <!--    </div>-->
      <!--  </div>-->
      <!--</section>-->
    </main>
    <!-- Footer-->
     <footer class="footer bg-dark pt-5 pt-md-6">
      <div class="container pt-3 pt-md-0">
        <div class="row pb-3">
          <div class="col-md-9 mt-n2 pb-3 pb-md-0 mb-4"><a class="d-block mb-3" href="index.html" style="width: 153px;"><img src="http://localhost/zapdevelop/assets/logonew.jpg" alt="Around"></a>
            <p class="fs-sm text-light opacity-60 pb-2 pb-sm-3">Descomplica suas Vendas.</p>
            <!-- <a class="btn-social bs-outline bs-facebook bs-light bs-lg me-2 mb-2" href="#"><i class="ai-facebook"></i></a>
            <a class="btn-social bs-outline bs-twitter bs-light bs-lg me-2 mb-2" href="#"><i class="ai-twitter"></i></a>
            <a class="btn-social bs-outline bs-instagram bs-light bs-lg me-2 mb-2" href="#"><i class="ai-instagram"></i></a>
            <a class="btn-social bs-outline bs-google bs-light bs-lg me-2 mb-2" href="#"><i class="ai-google"></i></a> -->
          </div>
          ...
          <div class="col-lg-3 col-md-4 col-sm-5 pb-1 mb-4">
            <div class="widget widget-light">
        ...
        <div class="row align-items-center mt-3 py-4">
          <div class="col-md-6 order-md-1 mb-3 alin-items-center">
            <p class="fs-sm mb-0"><span class="text-light opacity-50 me-1">© DescomplicaZap. Feito com ♥ por</span><a class="nav-link-style nav-link-light" href="https://createx.studio/" target="_blank" rel="noopener">Lucas Vieira</a></p>
          </div>
        </div>
      </div>
    ...
    <script src="<?=url('assets/js/cardapio/jquery.3.2.1.min.js')?>"></script>
    ...
    <script src="<?=url('assets/vendor/lightgallery.js/dist/js/lightgallery.min.js')?>"></script>
    ...
    <script src="<?=url('assets/site/assets/js/payment.js')?>"></script>
    ...
    <script>
        ...
        document.getElementById("texto-pix").select();
        
        document.execCommand('copy');
        
        document.getElementById("botao-pix").innerText = "Copiado!";
...
<!-- Mirrored from around.createx.studio/contacts-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Mar 2021 21:49:48 GMT -->
</html>