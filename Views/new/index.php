...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?=url('assets/giphy.gif');?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?=url('assets/giphy.gif');?>">
  ...
  <body>
    ...
    <div class="page-loading active">
      <div class="page-loading-inner">
        ...
        <img src="<?=url('assets/site/assets/images/giphy.gif')?>" style="width:100px;"/>
      </div>
    </div>
    <main class="page-wrapper">
        ...
        <div class="container px-0 px-xl-3">
          ...
          <div class="offcanvas offcanvas-collapse order-lg-2" id="primaryMenu">
            ...
            <div class="offcanvas-body">
              <!-- Menu-->
              <ul class="navbar-nav">
              <li class="nav-item dropdown dropdown-mega <?=($viewData['menu'] == 'home') ? 'active':''?>">
                  <a class="nav-link" href="http://localhost/zapdevelop/doceria-loh-macedo" target="_blank">Loja Modelo</a>
                </li>
                <li class="nav-item dropdown dropdown-mega <?=($viewData['menu'] == 'contato') ? 'active':''?>">
                  <a class="nav-link" href="<?=url('contato')?>">Fale com a Gente</a>
                </li>
      ...
      <section class="jarallax bg-gradient pt-5 pb-7 pt-md-7" data-jarallax data-speed="0.25"><span class="position-absolute top-0 start-0 w-100 h-100 bg-gradient opacity-80"></span>
        <div class="jarallax-img" style="background-image: url(<?=url('assets/img/pages/contacts/con1.jpg')?>);background-size: contain;"></div>
        ...
        <div class="container position-relative zindex-5 pt-3 pb-7 pt-md-0">
          <div class="row justify-content-center pb-7">
            <div class="col-lg-10">
              <h1 class="text-light">Cadastre Aqui! 👇👇👇</h1>
              <p class="text-light">Digite os dados da sua Empresa</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-7 offset-lg-1 pb-2 mb-5" style="margin-top: -260px;">
            <div class="card border-0 shadow-lg">
              <form class="card-body needs-validation p-5" novalidate method="post" action="<?=url('record')?>">
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-fn">Nome da Empresa<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" type="text" name="name_company" id="cont-fn" placeholder="Digite aqui..." required>
                  <div class="invalid-feedback">Escreva o nome da empresa!</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-fn">Whatsapp<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" type="text" name="phone" id="cont-fn" placeholder="Digite aqui..." required  placeholder="5534000000000">
                  <div class="invalid-feedback">Digite seu whatsapp!</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-email">CEP<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" type="text" id="cep-address" name="cep" placeholder="Digite aqui..." required data-format="custom" data-delimiter="-" data-blocks="5 3" placeholder="00000-000">
                  <div class="invalid-feedback">Digite o CEP!</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-phone">Rua</label>
                  <input class="form-control bg-image-0" name="street" type="text" id="rua-address" placeholder="Digite aqui...">
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-phone">Número</label>
                  <input class="form-control bg-image-0" name="number" type="text" placeholder="Digite aqui...">
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-company">Bairro</label>
                  <input class="form-control bg-image-0" name="neighborhood" type="text" id="bairro" placeholder="Digite aqui...">
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-subject">Cidade<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" name="city" type="text" id="cidade-address" placeholder="Digite aqui..." required>
                  <div class="invalid-feedback">Digite uma Cidade</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-subject">Estado<sup class="text-danger ms-1">*</sup></label>
                  <select class="form-control" name="state"  id="estado-address" required>
                ...
                <div class="mb-3 pb-1">
                    <label class="form-label" for="cont-subject">Ramo de atuação<sup class="text-danger ms-1">*</sup></label>
                    <select class="form-control" name="category_name" required>
                      <option value="restaurante">Escolha uma Opção</option>
                      <option value="restaurante">Comida (Food)</option>
                      <option value="roupas">Loja</option>
                    </select>
                  <div class="invalid-feedback">Escolha uma opção</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-subject">E-mail de acesso ao portal<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" name="email_user" type="email" id="" placeholder="Digite aqui..." required>
                  <div class="invalid-feedback">Digite um email de acesso</div>
                </div>
                <div class="mb-3 pb-1">
                  <label class="form-label" for="cont-subject">Senha de acesso ao portal<sup class="text-danger ms-1">*</sup></label>
                  <input class="form-control" name="senha" type="password" id="" placeholder="Digite aqui..." required>
          ...
          <div class="col-lg-4 col-md-4 offset-md-1">
                <img src="<?=url('assets/img/pages/contacts/man.png')?>" style="transform: scaleX(-1);">
          </div>
        </div>
      </section>
    </main>
    <!-- Footer-->
     <footer class="footer bg-dark pt-5 pt-md-6">
      <div class="container pt-3 pt-md-0">
        <div class="row pb-3">
          <div class="col-md-9 mt-n2 pb-3 pb-md-0 mb-4"><a class="d-block mb-3" href="index.html" style="width: 153px;"><img src="<?=url('assets/logonew.jpg')?>" alt="Around"></a>
          ...
          <div class="col-lg-3 col-md-4 col-sm-5 pb-1 mb-4">
            <div class="widget widget-light">
              <h4 class="widget-title">Nosso Instagram</h4>
              <ul>
                <a class="btn-social bs-outline bs-instagram bs-light bs-lg me-2 mb-2" href="https://www.instagram.com/descomplicazap/" target="_blank"><i class="ai-instagram"></i></a>
              </ul>
            </div>
          </div>
