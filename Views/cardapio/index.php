    ...
    <main>
        ...
        <div class="tab">
            <button class="tablinks active" style="font-weight: bold;" onclick="openCity(event, 'cardapio')">
                <?php if(getStore()->category_company === 'restaurante'):?>
                    <span class="material-icons">local_dining</span>Cardápio
                <?php else: ?>
                    <span class="material-icons">menu_book</span>Catálogo
                <?php endif; ?>
            </button>
      ...
      location_on
        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
            ...
            <div id="search-hide">
                ...
                <h2 id="<?=$item['name_category']?>" class="name-category"><?=$item['name_category']?></h2>
                ...
                <div class="card-c shadow" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')">
                    ...
                    <div class="row-c">
                        ...
                        <div class="info-c">
                            ...
                            <p class="card-text text-truncate card-text-t">
                                <?=$prod['description']?></p>
                ...
                <?php else: ?>
                <div class="card mb-3" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')" style="border-radius: 10px;filter: drop-shadow(0px 1px 5px rgba(0, 0, 0, 0.2));">
                    <?php if($prod['promo'] === 'yes'): ?>
                        <div class="ribbon">
                            <div class="wrap">
                                <span class="ribbon6">Promoção</span>
                    ...
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?=$prod['image']?>" style="width:100%;border-radius: 10px;object-fit: cover;"
                                alt="<?=$prod['name_product']?>">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title" style="font-weight:bold;color:#555;"><?=$prod['name_product']?>
                                </h5>
                                <p class="card-text" style="color: #777;font-size: 0.9rem;">
                                    <?=$prod['description']?></p>
                                <p class="card-text">
                                    <?php if($prod['promo'] === 'yes'): ?>
                            ...
                            <div class="modal-dialog modal-fullscreen">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <button type="button" style="background-color:#fff"; class="btn-close" data-bs-dismiss="modal"
                                    ...
                                    <?php
                                    $semana = ["Domingo" => "Domingo", "Segunda" => "Segunda", "Terça" => "Terça", "Quarta" => "Quarta", "Quinta" => "Quinta", "Sexta" => "Sexta", "Sábado" => "Sábado"];
                                    $hora = Date('H');
