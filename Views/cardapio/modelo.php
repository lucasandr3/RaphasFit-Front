...
<head>
    ...
    <style>
        ...
        .introjs-progressbar {
            background-color: <?=getStore()->config['color_primary']?>!important;
        }
        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
            ...
            <div id="search-hide">
                ...
                <?php elseif($config['view_products'] == '1'): ?>
                    ...
                    <div class="card" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')" style="border-radius: 10px;
                        filter: drop-shadow(0px 1px 5px rgba(0, 0, 0, 0.2));margin: 0 5px 10px;width: 33%;flex-grow: 1;min-height: 120px;box-sizing: border-box;justify-content: space-between;text-align: center;" id="step-two">
                        <?php if($prod['promo'] === 'yes'): ?>
                            <div class="ribbon">
                                <div class="wrap">
                                    <span class="ribbon6">Promoção</span>
                        ...
                        <div class="modal fade" id="modalproduct<?=$prod['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                            ...
                            <div class="modal-dialog modal-fullscreen">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="padding:0;" id="step-three">
                                                    ...
                                                    <?php foreach($option['options'] as $op): ?>
                                                        ...
                                                        <?php foreach($op['options_categorie_item'] as $items): ?>
                                                            <div class="form-check">
                                                                <div>
                                                                    <input class="form-check-input check-options form-check-limit" data-limit="1" type="checkbox" value="<?=$items['name_option_item']?>,<?=$items['price_option_item']?>" id="<?=$items['name_option_item']?>">
           ...
           <div class="modal fade" id="modalproductadicionais<?=$prod['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-fullscreen">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-capitalize name-adi" id="exampleModalLabel"><?=$prod['name_product']?></h5>
                            ...
                            <div class="modal-body" style="padding:0;">
                                ...
                                <div class="content-modal" style="top:0;">
                                <?php if(isset($p_options)): foreach($p_options as $option): ?>
                            ...
                            <div class="m-footer-dark" style="display:flex;padding:10px;border-top: 1px solid #dee2e6;" id="">
                                <button type="button" id="btn-close-modal" class="btn btn-outline-secondary" data-bs-dismiss="modal"
                                        style="display: flex;margin-right: 15px;" onclick="closeModalAdicionais(<?=$prod['id']?>)"><span class="material-icons"
                                                                                                            style="margin-right:5px;">keyboard_backspace</span> Voltar</button>
                                <button type="button" class="btn btn-success" style="width:100%;" onclick="updateAditionais('<?=$prod['id']?>')">Atualizar</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a onclick="cartData()" class="btn btn-warning btn-float" style="display: none;"><span style="font-weight:bold;display: flex;justify-content:space-between">Minha sacola <span id="total-bag-cart"></span><span class="material-icons">shopping_bag</span></span></a>
    </main>
    </div>
    <!-- Modal cart -->
...
<!--                                <button class="btn-address" onclick="deleteAddress()"><span class="material-icons">delete</span> Deletar</button>-->
                    ...
                    <div class="card-whatsapp shadow">
                        ...
                        <div class="col-12" style="margin-top: 10px;">
                            ...
                            <input type="tel" class="form-control" placeholder="Digite seu Whatsapp" onkeyup="clientSave()" id="client-phone">
                        </div>
                    </div>
                    <div class="card-whatsapp shadow">
                        <div class="col-12" style="margin-top: 10px;">
