    ...
    <span class="material-icons">
      location_on
        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
            ...
            <a onclick="cartData()" class="btn btn-warning btn-float" style="display: none;"><span style="font-weight:bold;display: flex;">Minha sacola <span class="material-icons">shopping_bag</span></span></a>
    </main>
    </div>
    <!-- Modal cart -->
