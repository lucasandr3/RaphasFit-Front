        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
            ...
            <div id="search-hide">
                <nav class="navTop">
                    ...
                    <a href="#<?=$category['name_category']?>" class="botones-menu shadow step-one" id="categ-menu-a">
                ...
                <?php else: ?>
                    ...
                    <div class="card" onclick="verifyDay('<?=$prod['id']?>','<?=$prod['category']?>')" style="border-radius: 10px;filter: drop-shadow(0px 1px 5px rgba(0, 0, 0, 0.2));margin: 0px 0px 15px 0px;" id="step-two">
                        <?php if($prod['promo'] === 'yes'): ?>
                            <div class="ribbon">
                                <div class="wrap">
                                    <span class="ribbon6">Promoção</span>
                ...
                <?php endif; ?>
                        ...
                        <div class="modal fade" id="modalproduct<?=$prod['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel"
                             aria-hidden="true">
                            <div class="modal-dialog modal-fullscreen" id="step-three">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="padding:0;" id="step-four">
            ...
            <a onclick="cartData()" class="btn btn-warning btn-float" style="display: none;color:#353535;" id="step-five"><span class="material-icons">shopping_bag</span></a>
    </main>
    </div>
    <!-- Modal cart -->
