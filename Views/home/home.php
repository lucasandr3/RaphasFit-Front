...
<head>
    ...
    <!-- <link rel="stylesheet" href="https://eanbowman.com/css/enjoyhint.css"> -->
    <style>
        body {
    ...
    <span class="material-icons">
      location_on
        ...
        <div id="cardapio" class="tabcontent" style="display:block;">
                            ...
                            <div class="modal-dialog modal-fullscreen">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="padding:0;">
                                        ...
                                        <?php else: ?>
                                            <img src="<?=getStore()->information['logo']?>" class="img-modal-cart" style="object-fit:cover;" id="img-cart<?=$prod['id']?>">
                                        <?php endif; ?>
                                        ...
                                        <div class="content-modal">
                                            ...
                                            <div>
                                                ...
                                                <?php if($countadd): ?>
                                                    <div class="qtp-cart">
                                                <?php else: ?>
                                                    <div class="qtp-cart" style="position: fixed;left: 20px;right: 20px;bottom: 75px;">
                                                <?php endif; ?>    
                                    ...
                                    <?php if($prod['shedule'] === 'true'): ?>
                                        ...
                                        <div class="m-footer-dark" style="display:flex;padding:10px;border-top: 1px solid #dee2e6;" id="btn-day-cart<?=$prod['id']?>">
                                            ...
                                            <button type="button" class="btn btn-success" style="width:100%;background-color:<?=explode(',', getStore()->config['modal_header'])[0]?>" onclick="mountOrder('<?=$prod['id']?>')">Adicionar ao
                                                carrinho</button>
                                        </div>
                                        <?php else: ?>
            ...
            <a onclick="cartData()" class="btn btn-warning btn-float" style="display: none;justify-content: space-between;font-weight:bold;"><span>Minha Sacola <span id="total-bag-cart"></span></span><span class="material-icons" style="font-size:35px;">shopping_bag</span></a>
    </main>
    </div>
    <!-- Modal cart -->
...
<!--                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>-->
    ...
    // <script src="https://eanbowman.com/js/enjoyhint.min.js"></script>
